...
from custom_layers import Scale, BatchRenormalization


def densenet(img_rows, img_cols, lr=0.01, color_type=1, nb_dense_block=4, growth_rate=32,
             nb_filter=64, reduction=0.5, dropout_rate=0.0, weight_decay=1e-4,
             num_classes=None, opt='sgd', bn_type='bn'):
    '''
    ...
    x = BatchNorm(epsilon=eps, axis=concat_axis, name='conv'+str(final_stage)+'_blk_bn')(x)
...
def conv_block(x, stage, branch, nb_filter, dropout_rate=None, weight_decay=1e-4):
    ...
    x = BatchNorm(epsilon=eps, axis=concat_axis, name=conv_name_base+'_x1_bn')(x)
    ...
    # 3x3 Convolution
    x = BatchNorm(epsilon=eps, axis=concat_axis, name=conv_name_base+'_x2_bn')(x)
...
def transition_block(x, stage, nb_filter, compression=1.0, dropout_rate=None, weight_decay=1E-4):
    ...
    x = BatchNorm(epsilon=eps, axis=concat_axis, name=conv_name_base+'_bn')(x)
