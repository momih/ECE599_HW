...
tf.app.flags.DEFINE_string('version', 'testing', '''A version number defining the directory to save
...
time''')
tf.app.flags.DEFINE_integer('decay_step0', 5000, '''At which step to decay the learning rate''')
tf.app.flags.DEFINE_integer('decay_step1', 7500, '''At which step to decay the learning rate''')
...
tf.app.flags.DEFINE_string('ckpt_path', 'logs_batch-size256/model.ckpt-5000', '''Checkpoint
